...
public class AddressController {
	...
	public ResponseEntity<Address> getAddressByCustomerId(@PathVariable int aid) throws AddressException,CustomersException{
	...
	public ResponseEntity<Address> updateAddressByCustomerId(@PathVariable int aid,@RequestBody Address address)throws AddressException,CustomersException{
	...
	public ResponseEntity<Address> deleteAddressByCustomerId(@PathVariable int aid)throws AddressException,CustomersException{
